...
if (typeof globalThis.HTMLElement === "undefined") {
	class DummyNode {}
	globalThis.HTMLElement = DummyNode;
	globalThis.Element = DummyNode;
	globalThis.Node = DummyNode;
	globalThis.Event = DummyNode;
	globalThis.CustomEvent = DummyNode;
}
if (typeof globalThis.customElements === "undefined") globalThis.customElements = {
	get: () => void 0,
	define: () => {},
