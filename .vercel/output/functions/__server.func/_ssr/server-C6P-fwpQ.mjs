...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DbwpZI17.mjs");
...
var manifest = {
	"31451354cef254f93339c2af2e762dfcd2ec1d54597c6209cb1e8341a7d1a402": {
		...
		importer: () => import("./settings.functions-DDZic1-N.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CnXKmlGA.mjs").then((n) => n.t),
