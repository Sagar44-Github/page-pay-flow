...
//#region node_modules/.nitro/vite/services/ssr/assets/x402-DX-wArvu.js
var import_jsx_runtime = require_jsx_runtime();
var X402_SECTIONS = [
	{
		id: "overview",
		title: "Overview",
		body: `**x402** revives [HTTP 402 Payment Required](https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/402) as a first-class, machine-readable payment negotiation layer for APIs, agents, and automated clients.
...
PagePay implements **x402 version 2** with the **exact-AVM** scheme on Algorand Testnet. This document covers every header, field, state transition, and failure mode you will encounter integrating against PagePay or building a compatible client.`
	},
	{
		id: "why-402",
		title: "Why HTTP 402?",
		body: `Traditional API monetization stacks billing as a separate concern:
...
**Benefits for agentic workloads:** AI agents can discover price, pay, and consume in one programmatic loop without human account setup. **Benefits for developers:** payment requirements are self-describing JSON — no separate pricing page scrape required.`
	...
	{
		id: "v2-headers",
		title: "Version 2 headers",
		body: `x402 v2 standardizes three HTTP headers. PagePay uses lowercase header names in logs; HTTP is case-insensitive.
...
**Important:** x402 v1 used \`X-Payment\`. PagePay and \`@x402-avm\` v2 use \`PAYMENT-SIGNATURE\`. Clients must not send legacy v1 headers.`,
		code: {
			title: "402 response headers (example)",
...

{
  ...
  "error": "Payment required"
	...
	{
		id: "payment-requirement",
		title: "Payment requirement object",
		body: `Each entry in the \`accepts\` array describes one valid way to pay. PagePay publishes a single **exact-AVM** requirement per quote.
...
The \`extra.feePayer\` field indicates the GoPlausible facilitator will co-sign as fee payer in the atomic transaction group.`,
		code: {
			title: "Decoded payment requirement",
			code: `{
  "scheme": "exact",
  ...
  "maxTimeoutSeconds": 300
	...
	{
		id: "client-flow",
		title: "Client flow (step by step)",
		body: `### Step 1 — Unpaid request
...
On **200**, decode \`PAYMENT-RESPONSE\` for \`txId\`. Confirm on Algorand explorer independently.`
	...
	{
		id: "simulation-modes",
		title: "Protocol sandbox simulation modes",
		body: `The [\`/x402-demo\`](/x402-demo) page supports four client-side simulation modes that mock facilitator and server behavior without wallet funding:
...
Use simulation modes to teach the protocol, test UI error states, and capture raw header payloads for documentation.`
	},
	{
		...
		body: `| Status | Meaning | Client action |
| --- | --- | --- |
...
\`\`\``
	},
	{
		...
		body: `PagePay uses these packages — mirror them in your own client:
...
See the [Developers](/developers) page for curl examples and the [Integrations](/integrations) page for wallet-specific signing notes.`
	}
];
function DocsX402Page() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MarketingPageStatic, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DocsLayout, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DocSections, { sections: X402_SECTIONS })
	}) });
}
//#endregion
export { DocsX402Page as component };
