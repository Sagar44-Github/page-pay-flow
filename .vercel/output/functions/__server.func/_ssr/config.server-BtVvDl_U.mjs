...
//#region node_modules/.nitro/vite/services/ssr/assets/config.server-BtVvDl_U.js
var config_server_BtVvDl_U_exports = /* @__PURE__ */ __exportAll({
...
var overrides = {};
var DEFAULT_PAY_TO = "UPRVZO4TROKAOI2KBRWKVKQUWXNV4DQ4NDL5PEARA4IVZ73DDROT2ATSV4";
function fromEnv() {
	const envPrice = Number(process.env["PRICE_PER_PAGE_USD"]);
	return {
		payTo: process.env["RESOURCE_PAY_TO"] || "UPRVZO4TROKAOI2KBRWKVKQUWXNV4DQ4NDL5PEARA4IVZ73DDROT2ATSV4",
...
//#endregion
export { pagesForText as a, getConfig as i, config_server_BtVvDl_U_exports as n, priceForPages as o, formatAtomicAmount as r, validatePageRange as s, MAX_TEXT_CHARS as t };
