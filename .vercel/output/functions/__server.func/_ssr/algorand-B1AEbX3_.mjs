...
//#region node_modules/.nitro/vite/services/ssr/assets/algorand-B1AEbX3_.js
var import_jsx_runtime = require_jsx_runtime();
var ALGORAND_SECTIONS = [
	{
		id: "network",
...
function DocsAlgorandPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MarketingPageStatic, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DocsLayout, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DocSections, { sections: ALGORAND_SECTIONS })
	}) });
}
//#endregion
export { DocsAlgorandPage as component };
